...
def avg_category(movie_list, category):
    ...
    return round(total_score/len(category_movies), 2)

user_category = input("Enter a category: ")
print("Average IMDB score for", user_category, ":", avg_category(movies, user_category))